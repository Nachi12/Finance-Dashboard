...
try {
    ...
    if ($uri === '/' || $uri === '' || $uri === '/index.php') {
        ...
        $file = dirname(__DIR__) . '/api/' . $matches[1];
    ...
    } elseif (file_exists(dirname(__DIR__) . $uri) && is_file(dirname(__DIR__) . $uri) && pathinfo($uri, PATHINFO_EXTENSION) === 'php') {
        require dirname(__DIR__) . $uri;
    } else {
        http_response_code(404);
        echo "404 Not Found";
    }
